...
# Theme - color palette = viridis, plasma option
...
# Plot 1 - line graph of uninsured rate by region over year and population size in each reigon
...
# Plot 4: treemap of hispanic uninsured rates in 2012 and 2016 by state and region
...
# Plot 5: treemap of hispanic uninsured rates in 2016 by state and region
...
# Plot 7: Jitter plot comparing uninsured rates to reporting of fair/poor health status
...
# Plot 8: bar graph showing fair/poor health status reporting by race in each region.
